...
#     # Create HTML header with enhanced styling and load Google Charts
#     cat <<EOF > "$html_file"
# <!DOCTYPE html>
# <html lang="en">
# <head>
...
#         echo "            data.addColumn('number', '${error_type^} Error');" >> "$html_file"
#     done

#     # Add data rows
#     echo "            data.addRows([" >> "$html_file"
#     for ((i=6; i>=0; i--)); do
#         current_date=$(date -d "$i days ago" "+%F")
#         echo -n "                ['$current_date'" >> "$html_file"
#         for error_type in "${!error_types[@]}"; do
#             count=${daily_counts["$current_date,$error_type"]:-0}
#             echo -n ", $count" >> "$html_file"
#         done
#         echo "]," >> "$html_file"
#     done

#     # Complete HTML with charts
#     cat <<EOF >> "$html_file"
#             ]);

#             var options = {
#                 title: 'System Log Error Trends Over Last 7 Days',
#                 titleTextStyle: { 
#                     color: '#2c3e50',
#                     fontSize: 18,
#                     bold: true 
...
#     # Add pie chart data
#     for error_type in "${!error_types[@]}"; do
#         echo "                ['${error_type^} Error', ${total_counts[$error_type]}]," >> "$html_file"
#     done

#     # Add application error distribution
#     cat <<EOF >> "$html_file"
#             ]);

#             var pieOptions = {
#                 title: 'Error Type Distribution Over Last 7 Days',
#                 titleTextStyle: { 
#                     color: '#2c3e50',
#                     fontSize: 18,
#                     bold: true 
...
#             // Bar chart for top applications
#             var appData = new google.visualization.DataTable();
#             appData.addColumn('string', 'Application');
#             appData.addColumn('number', 'Errors');
#             appData.addRows([
...
#     # Add top 10 applications data
#     local count=0
#     for app in $(echo "${!app_error_counts[@]}" | tr ' ' '\n' | sort -r); do
#         ((count++ < 10)) || break
#         echo "                ['$app', ${app_error_counts[$app]}]," >> "$html_file"
#     done
...
#             var appChart = new google.visualization.BarChart(document.getElementById('appchart'));
#             appChart.draw(appData, appOptions);
#         }
#     </script>
# </head>
# <body>
#     <h1>System Log Error Trends (Last 7 Days)</h1>
    
#     <div class="system-info">
#         <h2>System Resource Status</h2>
#         <div class="info-grid">
#             <div class="info-card">
#                 <h3>Disk Usage</h3>
...
#     <div class="chart-container">
#         <div id="appchart" style="width: 100%; height: 600px;"></div>
#     </div>
...
# function generate_html_report {
#     local html_file="syslog_trend_report.html"
#     local start_date="$1"    # Get start_date as parameter
#     local end_date="$2"      # Get end_date as parameter
#     local temp_file="$3"     # Get temp_file as parameter
...
# <head>
#     <meta charset="UTF-8">
#     <title>System Log Error Report (Last 7 Days)</title>
#     <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
#     <style>
#         body {
#             font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
...
#                 ['CPU Throttling', ${total_counts[throttling]}],
...
#             // Application errors chart
#             // Extract top 10 applications and their error counts
...
#                 }
#                 /error|fail|critical|emergency|alert|panic|fatal/i {
#                     if ($0 ~ /info|debug|notice|success|trying|retry|recovered/) { next }
                    
#                     if (match($0, /\[[^]]+\]/) || match($0, /^[a-zA-Z][a-zA-Z0-9_-]+[: \[]/) || 
#                         match($0, /^[-_a-zA-Z0-9]+:/) || match($0, /kernel: \[[0-9. ]+\] [a-zA-Z0-9_-]+:/)) {
#                         app = substr($0, RSTART, RLENGTH)
#                         gsub(/[\[\]:]/, "", app)
#                         gsub(/^kernel: /, "", app)
#                         gsub(/[0-9. ]+$/, "", app)
...
#                     for (app in count) {
#                         if (n++ < 10) {
#                             gsub(/'/, "\047", app)  # Escape single quotes
#                             printf "[\047%s\047, %d],\n", app, count[app]
#                         }
#                     }
